        ...
        <div class="max-w-7xl px-4 sm:px-6 lg:px-8 py-12 lg:py-12 mx-auto">
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-12">
                @forelse($sentRequests as $request)
                    @include('connections.sent-pending-card', ['connectionUser' => $request->receiver])
                @empty
                    <div class="col-span-full text-center py-12">
                        <svg class="mx-auto h-16 w-16 text-gray-400 dark:text-neutral-500" fill="none"
                             stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                  d="M12 19l9 2-9-18-9 18 9-2zm0 0v-8"></path>
                        </svg>
                        <h3 class="mt-4 text-lg font-medium text-black dark:text-white">No sent requests</h3>
                        <p class="mt-2 text-gray-500 dark:text-neutral-400">You haven't sent any connection requests
                            yet.</p>
                        <div class="mt-6">

<div class="relative">
    <div class="aspect-4/4 overflow-hidden rounded-2xl">
        @if($connectionUser->getMainProfileImagePath())
            <img class="size-full object-cover rounded-2xl" src="{{ Storage::url($connectionUser->getMainProfileImagePath()) }}" alt="{{ $connectionUser->full_name }}">
        @else
    ...
    <div class="flex flex-col">
        ...
        <div class="py-3 border-t border-gray-200 dark:border-neutral-700">
            <div class="grid grid-cols-2 gap-2">
                ...
                <div class="text-end">
                    <span class="text-black dark:text-white">
                        {{ $connectionUser->whatsapp_number }}
                    </span>
                </div>
            </div>
        </div>

...
@section('content')
    <div class="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0">
        ...
        <div class="w-full sm:max-w-md">
            <!-- Card -->
            <div class="border border-gray-200 rounded-xl shadow-sm dark:bg-gray-800 dark:border-gray-700">
                    ...
                    <div class="mt-5">
                        ...
                        <form action="{{ route('magic-link.verify') }}" method="POST">
                            ...
                            <div class="grid gap-y-4">
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        <input type="text" id="token" name="token" maxlength="6" required
                                               class="border border-gray-200 py-3 px-4 block w-full rounded-lg text-center text-2xl tracking-widest font-mono focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400 dark:focus:ring-gray-600"
                                ...
                                <button type="submit"
                                        class="w-full py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-yellow-400 text-black hover:bg-yellow-500 focus:outline-hidden focus:bg-yellow-500 transition disabled:opacity-50 disabled:pointer-events-none cursor-pointer"
                                >
                        ...
                        <div class="text-center text-xs">
                            <a href="{{ route('login') }}"
                               class="relative inline-block font-medium text-black before:absolute before:bottom-0.5 before:start-0 before:-z-1 before:w-full before:h-1 before:bg-yellow-400 hover:before:bg-black focus:outline-hidden focus:before:bg-black dark:text-white dark:hover:before:bg-white dark:focus:before:bg-white"
                            >
                                Back to login
                            </a>
                        </div>
                        ...
                        <div class="text-center mt-3">
                            <p class="text-xs text-gray-600 dark:text-gray-400">
                                ...
                                <a href="{{ route('login') }}?email={{ urlencode($email) }}"
                                   class="relative inline-block font-medium text-black before:absolute before:bottom-0.5 before:start-0 before:-z-1 before:w-full before:h-1 before:bg-yellow-400 hover:before:bg-black focus:outline-hidden focus:before:bg-black dark:text-white dark:hover:before:bg-white dark:focus:before:bg-white"
                                >
                                    Send a new code
                                </a>
